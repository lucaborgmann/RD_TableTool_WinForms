...
namespace RD_Table_Tool
{
    class XML
    {
        ...
        public static void CreateTable(string pName, string pLabel, string pOutputPath, ArrayList fieldList)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"Größe der Arrayliste: {fieldList.Count}");
            ...
            try
            {
                ...
                if (fieldNode != null)
                {
                    ...
                    string fieldLabel = "";
                    string fieldBaseEDT = "";
                    string fieldCreatEDT = "";

                    //foreach (ArrayList row2 in fieldList)
                    foreach (Dictionary<string, string> fieldDict in fieldList) //Durchläuft die inneren Dictonarys in der ArrayList
                    {
                        ...
                        if (fieldDict != null)
                        {
                            ...
                            fieldLabel = fieldDict["Label"];
                            fieldBaseEDT = fieldDict["BaseEDT"];
                            fieldCreatEDT = fieldDict["CreateEDT"];
                        ...
                        // typeAttribute.Value = "AxTableFieldString";
